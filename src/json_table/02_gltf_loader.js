...
var gui = new dat.GUI();
{
  ...
  var tableFolder = gui.addFolder('tableFolder');
  var tableProperty = new function () {
    this.name = 'test'
  }
  ...
  for(var key in obj) {   
    ...
    tableFolder.add(prop, 'name', value);
    console.log('---------------'+value);
  }
  // tableFolder.add(obj, obj.key, obj.value);
  // obj.foreach(element => {
  //   var prop = new function () {
  //     this.name = element.value
  //   };
  //   tableFolder.add(prop, 'name', element.value);
  // });

   // tableFolder.add(tableProperty, 'name', 'xiaolu').onChange(value => {
