...
planeFolder.add(planeProperty, 'width',0,50).onChange(w=>{
  scene.remove(planeGeom);
  planeGeom = new THREE.PlaneGeometry(planeProperty.width,planeProperty.height,planeProperty.widthSegments,planeProperty.height);
  var planeMat = new THREE.MeshBasicMaterial({ color: 0x00ff00});
  planeMat.side = THREE.DoubleSide;
...
planeFolder.add(planeProperty, 'height',0,50).onChange(w=>{
  scene.remove(planeGeom);
  planeGeom = new THREE.PlaneGeometry(planeProperty.width,planeProperty.height,planeProperty.widthSegments,planeProperty.height);
  var planeMat = new THREE.MeshBasicMaterial({ color: 0x00ff00});
  planeMat.side = THREE.DoubleSide;
...
planeFolder.add(planeProperty, 'widthSegments',0,50).onChange(w=>{
  scene.remove(planeGeom);
  planeGeom = new THREE.PlaneGeometry(planeProperty.width,planeProperty.height,planeProperty.widthSegments,planeProperty.height);
  var planeMat = new THREE.MeshBasicMaterial({ color: 0x00ff00});
  planeMat.side = THREE.DoubleSide;
...
planeFolder.add(planeProperty, 'heightSegments',0,50).onChange(w=>{
  scene.remove(planeGeom);
  planeGeom = new THREE.PlaneGeometry(planeProperty.width,planeProperty.height,planeProperty.widthSegments,planeProperty.height);
  var planeMat = new THREE.MeshBasicMaterial({ color: 0x00ff00});
  planeMat.side = THREE.DoubleSide;
